...
const ARGO_DOMAIN = process.env.ARGO_DOMAIN || 'cho0728.edmenbender.eu.org ';     // 建议使用token，argo端口8080，cf后台设置需对应,使用json需上传json和yml文件至files目录
...
const NAME = process.env.NAME || 'Cho0529';
